      ...
      <div className="tweets">
        <div className="tweet">
          <div className="tweet-avatar">
            <a className="tweet-title-author" href="/CNN">
              <img
                src="/src/assets/images/tweet-profile-photo.png"
                alt="tweet avatar"
              />
            </a>
          </div>
          <div className="tweet-content">
            <div className="tweet-body">
              <div className="tweet-title">
                ...
                <div className="tweet-title-details">
                  <a className="username-link" href="/CNN">
                    <span className="userName">@CNN</span>
                  </a>
                  <span className="dotSeparate"> . </span>
                  <span className="dateTime">7m</span>
                </div>
              </div>
            ...
            <div className="tweet-actions">
              <div className="tweet-action hoverReply">
                ...
                <span className="hoverReplyText">57</span>
              </div>
              <div className="tweet-action hoverRetweet">
                ...
                <div className="svg-border" />
                <span className="hoverRetweetText">144</span>
              </div>
              <div className="tweet-action hoverReact false">
                <i className="ri-heart-line svgRemix" />
                <div className="svg-border" />
                <span className="hoverReactText false">184</span>
              </div>
              <div className="tweet-action hoverShare">
                ...
                <div className="svg-border" />
                <span className="hoverShareText" style={{ display: "none" }} />
              </div>
            </div>
          </div>
        </div>
        <div className="tweet">
          <div className="tweet-avatar">
            <a className="tweet-title-author" href="/nytimes">
              <img
                src="/src/assets/images/tweet-profile-photo-2.png"
                alt="tweet avatar"
              />
            </a>
          </div>
          <div className="tweet-content">
            <div className="tweet-body">
              <div className="tweet-title">
                ...
                <div className="tweet-title-details">
                  <a className="username-link" href="/nytimes">
                    <span className="userName">@nytimes</span>
                  </a>
                  <span className="dotSeparate"> . </span>
                  <span className="dateTime">2h</span>
                </div>
              </div>
              <div className="tweet-text">
                <p>
              ...
              <div className="tweet-image">
                <img src="/src/assets/images/tweet-image.png" alt="Tweet image" />
              </div>
            </div>
            <div className="tweet-actions">
              <div className="tweet-action hoverReply">
                ...
                <div className="svg-border" />
                <span className="hoverReplyText">19</span>
              </div>
              <div className="tweet-action hoverRetweet">
                <svg
                  width={24}
                ...
                <div className="svg-border" />
                <span className="hoverRetweetText">48</span>
              </div>
              <div className="tweet-action hoverReact false">
                <i className="ri-heart-line svgRemix" />
                <div className="svg-border" />
                <span className="hoverReactText false">482</span>
              </div>
              <div className="tweet-action hoverShare">
                <svg
                  width={24}
        ...
        <div className="tweet">
          <div className="tweet-avatar">
            <a className="tweet-title-author" href="/X">
              <img src="/src/assets/images/logoX.png" alt="tweet avatar" />
            </a>
          </div>
          <div className="tweet-content">
            <div className="tweet-body">
              <div className="tweet-title">
                ...
                <div className="tweet-title-details">
                  <a className="username-link" href="/X">
                    <span className="userName">@X</span>
                  </a>
                  <span className="dotSeparate"> . </span>
                  <span className="dateTime">Oct 29</span>
                </div>
              </div>
              <div className="tweet-text">
            ...
            <div className="tweet-actions">
              <div className="tweet-action hoverReply">
                ...
                <div className="svg-border" />
                <span className="hoverReplyText">6.8K</span>
              </div>
              <div className="tweet-action hoverRetweet">
                <svg
                  width={24}
                ...
                <div className="svg-border" />
                <span className="hoverRetweetText">36.6K</span>
              </div>
              <div className="tweet-action hoverReact false">
                <i className="ri-heart-line svgRemix" />
                <div className="svg-border" />
                <span className="hoverReactText false">267</span>
              </div>
              <div className="tweet-action hoverShare">
                <svg
                  width={24}
            ...
            <div className="tweet-body">
              <div className="tweet-title">
                ...
                <div className="tweet-title-details">
                  ...
                  <span className="dotSeparate"> . </span>
                  <span className="dateTime">Oct 4</span>
                </div>
              </div>
              <div className="tweet-text">
                <p>Hello litteraly everyone</p>
              </div>
              <div className="tweet-image" />
            </div>
            <div className="tweet-actions">
              <div className="tweet-action hoverReply">
                ...
                <div className="svg-border" />
                <span className="hoverReplyText">118.7K</span>
              </div>
              <div className="tweet-action hoverRetweet">
                <svg
                  width={24}
                ...
                <div className="svg-border" />
                <span className="hoverRetweetText">785.4K</span>
              </div>
              <div className="tweet-action hoverReact false">
                <i className="ri-heart-line svgRemix" />
                <div className="svg-border" />
                <span className="hoverReactText false">375</span>
              </div>
              <div className="tweet-action hoverShare">
                <svg
                  width={24}
          ...
          <div className="tweet-content">
            ...
            <div className="tweet-actions">
              ...
              <div className="tweet-action hoverReact false">
                <i className="ri-heart-line svgRemix" />
                <div className="svg-border" />
                <span className="hoverReactText false">3105</span>
              </div>
              <div className="tweet-action hoverShare">
                <svg
                  width={24}
